...
| **Yeni versiyon oluştur…** | `Ctrl+Shift+U` | O anki içeriği **arşivler** (ilk çağrı `v0`'ı yaratır); kısa bir not sorar. **Parça yalnız kendisi** arşivlenir; **montaj ve teknik resim** o günkü çocuklarıyla birlikte girer ve kutu kaç dosya olduğunu yazar. Dosya yerinde kalır. Panelde: **satırın** dosyasına açılır | Tek dosya seçili değilken · SOLIDWORKS dosyası değilken |
...
- **Çift tık** → o versiyonu **açar** (salt-okunur). Montaj ve teknik resim de açılır: her versiyon **kendi kendine yeter** — arşivde asıl dosya gerçek adıyla durur ve **o günkü çocukları** (parçalar, alt montajlar) yanındadır, SOLIDWORKS onları orada bulur. Hiçbir yere geçici dosya çıkmaz.
- **Versiyon = o günkü hâl.** "Yeni versiyon" kutusu kaç dosyanın arşivleneceğini yazar (*"Montaj1.SLDASM ve 12 dosya"* — kaçı doğrudan çocuk, kaçı alt seviye ayrı yazar) ve **"Listeyi göster…"** ile tam listeyi gösterir; disk maliyeti gözünün önündedir. Çözülemeyen referans varsa sayısı söylenir — eksik arşivlenen versiyon eksik açılır, bunu bilmelisin.
- **PARÇANIN VERSİYONU YALNIZ O PARÇADIR.** Montaj bağlamında (in-context) yapılmış bir parça, dosyasının içinde o **montajı** yazar — ama bu bağ *yukarı* gider: parçanın içinde montaj yok, parça o montajın içinde yapılmış. Versiyon o bağı **izlemez**; yoksa tek bir parçanın versiyonu bütün ürün ağacını arşive kopyalardı (01.09.2026'da tam bu oldu: 3 MB'lik bir parça için **162 dosya**). Montajın referansı **panelde görünmeye devam eder**, yalnız arşive girmez.
