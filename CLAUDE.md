...
> **YEREL MAKİNEDE ÇALIŞIYORSAN — [`YEREL-KURULUM.md`](YEREL-KURULUM.md).**
> §11 bulut kapsayıcısını (Linux + Wine) anlatıyor; Windows'ta hangi kapının
> koştuğu, hangisinin koşmadığı ve Wine'ın ölçemediği nelerin orada
> **ölçülebilir** olduğu o dosyada.
